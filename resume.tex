...
\end{center}
\par I am an experienced technical leader with a primary focus on quality and mentorship. Currently primarily focused on Ruby and associated libraries and tools. Through my skills in software design and testing, I aim to produce functional, maintainable software that meets business needs, and I strive to teach others how to do the same.
\noindent \mbox{}\\
