...
\begin{indentsection}{\parindent}
  ...
  \vspace{-0.1in}
    \item Primarly focused on upgrading the legacy Rails app from 4.2 to 5.0, completing the upgrade with a near-zero error rate
...
\begin{description}
  ...
  \item AJAX, AWS, Bash, CircleCI, Elasticsearch, Git, Linux, MySQL, PostgreSQL, Puma,
  \item RSpec, Rbenv, React, Redis, Resque, Ruby (On Rails), SQL, Sikekiq, Vim
  \item[Limited Experience]
  \item Ansible, Common, CSS, Docker, Go, Java, Javascript/Typescript, Lisp, Perl, Python/Django, \LaTeX
\end{description}
\end{indentsection}
\end{document}
