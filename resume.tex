...
\begin{indentsection}{\parindent}
  ...
  \vspace{-0.1in}
    ...
    \item Joined the Data Acceleration Team (DAT), working in Go/Ruby development tooling codebases and Terraform to provision internal developer development environments (a scaled down version of the entire platform)
    \item Maintained legacy cloud-based development environment tooling and infrastructure (Rails, GCP) used by all engineers to provision and interact with their cloud-based development environment
    \item Primary point-of-contact for development environment issues/requests for engineers company-wide
    \item Spearheaded DAT effort to modernize legacy Ruby-based command line interface to our internal cloud-based development environment tooling with a purpose-built Go command line interface
  \end{itemize}
\end{indentsection}
